...
A NeoForge mod for Minecraft 26.1.2 that removes unwanted UI elements so you can just play the game.
...
- Minecraft **26.1.2**
- [NeoForge](https://neoforged.net/) **26.1.x**

---

## Installation

1. Install [NeoForge 26.1.x](https://neoforged.net/) for Minecraft 26.1.2
